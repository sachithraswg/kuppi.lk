      ...
      <div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="row">
          <div class="text-center col-sm-8 col-sm-offset-2">
            ...
            <p>we know you face lot of trouble with theories. we are here to help you. and you can help others also. upload your tutorial videos. </p>
          </div>
        </div> 
      </div>
      <div class="text-center our-services">
        <div class="row">
          <div class="col-sm-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
              <div class="service-icon" style="padding-top: 25px">
              <i class="fa fa-video-camera"></i>
            </div>
            <div class="service-info">
              <h3>Video tutorials</h3>
              <p>If you like to watch and listen. There is video tutorials. you can learn things.</p>
            </div>
          </div>
          <div class="col-sm-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="450ms">
            ...
            <div class="service-info">
              ...
              <p>You may like to read. view, download and read it is totally free.</p>
            </div>
          </div>
          <div class="col-sm-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="550ms">
            ...
            <div class="service-info">
              ...
              <p>you are free to upload your video tutorial. It is help others to learn things quickly.</p>
            </div>
          </div>
